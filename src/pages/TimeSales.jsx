    ...
    return (
        <Container>
            <div style={{"text-align": "center"}}>
                <a href="https://www.kurly.com/shop/goods/goods_list.php?category=209">
                    <img style={{"width": "100%", "vertical-align": "top", "cursor": "pointer"}} 
                        src="https://collection-image.kurly.com/product-collections/2593/p60YmRzrzIl4Ek4FPIXAwJwG2HwUQQMiACAjIHct.jpg" alt="배너 이미지"/>               
                </a>
            </div>
            <Title>알뜰쇼핑</Title>
